        ...
        <div class="card custom-card">
            <div class="card-body">
                <a class="card-order" href="{{ route('expenses-reports.index') }}">
                    ...
                    <h2 class="text-right"><i class="icon-size mdi mdi-poll-box   float-left text-primary"></i><span class="font-weight-bold">₹{{ $totalExpense }}</span></h2>
        ...
        <div class="card custom-card">
            <div class="card-body">
                <a class="card-order" href="{{ route('water.index') }}">
                    ...
                    <h2 class="text-right"><i class="mdi mdi-cart icon-size float-left text-primary"></i><span class="font-weight-bold">₹{{ $totalWaterExpense }}</span></h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </a>
            </div>
        </div>
            ...
            <div class="card-body">
                <a class="card-order" href="{{ route('staffs.index') }}">
                    ...
                    <h2 class="text-right card-item-icon card-icon">
                        <i class="mdi mdi-account-multiple icon-size float-left text-primary"></i><span class="font-weight-bold">{{ $staffsCount }}</span>
                    </h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </a>
            </div>
