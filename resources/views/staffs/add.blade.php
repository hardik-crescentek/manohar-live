        ...
        <div class="col-lg-12 col-md-12">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <form class="parsley-validate" method="post" action="{{ route('staffs.store') }}"
                        ...
                        <div class="row row-sm">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="custom-radio-div">
                                    <label class="rdiobox d-inline-block mr-4" for="salaried"><input type="radio"
                                            class="type" name="type" value="1" id="salaried" checked>
                                        <span>Salaried</span></label>
                                    <label class="rdiobox d-inline-block" for="on-demand"><input type="radio"
                                            class="type" name="type" value="2" id="on-demand"> <span>On
                                            demand</span></label>
                                </div>
                            </div>
                            <div class="col-md-4 staff-type-container d-none">
                                ...
                                <div class="custom-radio-div">
                                    <label class="rdiobox d-inline-block mr-4" for="single"><input type="radio"
                                            class="staff_leader" name="staff_leader" value="0" id="single" checked>
                                        <span>Single staff</span></label>
                                    <label class="rdiobox d-inline-block" for="leader"><input type="radio"
                                            class="staff_leader" name="staff_leader" value="1" id="leader">
                            ...
                            <div class="col-md-6 salaried-container">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="salary" type="text"
                                        onkeypress="return onlyNumbers(event)" value="{{ old('salary') }}">
                                </div>
                            </div>
                            <div class="col-md-6 d-none demand-container">
                                <div class="form-group">
                                    <label class="">Rate / day</label>
                                    <input class="form-control" name="rate_per_day" type="text"
                                        onkeypress="return onlyNumbers(event)" value="{{ old('rate_per_day') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="phone" required="" type="text"
                                        onkeypress="return validatePhoneNumber(event)" value="{{ old('phone') }}">
                                    @error('phone')
                                        <ul class="parsley-errors-list filled">
                                            <li class="parsley-required">{{ $message }}</li>
                                        </ul>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control datepicker" placeholder="YYYY/MM/DD" type="text"
                                            name="joining_date" id="joining_date" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control datepicker" placeholder="YYYY/MM/DD" type="text"
                                            name="resign_date" id="resign_date" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row team-detail d-none" id="team-row-0">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="team_name[]" id="team_name_0" type="text"
                                        value="">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="team_role[]" id="team_role_0" type="text"
                                        value="">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control datepicker" placeholder="YYYY/MM/DD" type="text"
                                            name="team_joindate[]" id="team_joindate_0" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control datepicker" placeholder="YYYY/MM/DD" type="text"
                                            name="team_enddate[]" id="team_enddate_0" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2">
            ...
            $(document).on('click', '.add-row', function() {
                ...
                var rowHtml = `<div class="row team-detail" id="team-row-` + rowCounter + `">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="">Staff Role</label>
                                        <input class="form-control" name="team_role[]" id="team_role_` + rowCounter +
                    `" type="text" value="">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control datepicker" placeholder="YYYY/MM/DD" type="text" name="team_joindate[]" id="team_joindate_` + rowCounter +
                    `" value="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <button type="button" class="btn btn-success add-row mt-4">+</button>
                                        <button type="button" class="btn btn-danger remove-row mt-4" data-index="` +
                    rowCounter + `">-</button>
                                    </div>
                                </div>
                            </div>`;
