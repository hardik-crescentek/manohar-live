...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">Diesel</h2>
        <ol class="breadcrumb">
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-order">
                    ...
                    <h2 class="text-right"><i class="icon-size zmdi zmdi-gas-station   float-left text-primary"></i><span class="font-weight-bold">₹{{ $totalDiesel }}</span></h2>
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-order">
                    ...
                    <h2 class="text-right"><i class="zmdi zmdi-gas-station icon-size float-left text-primary"></i><span class="font-weight-bold">₹{{ $currentMonthDiesel }}</span></h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="card-order ">
                    ...
                    <h2 class="text-right card-item-icon card-icon">
                        <i class="zmdi zmdi-gas-station icon-size float-left text-primary"></i><span class="font-weight-bold">₹{{ $prevMonthDiesel }}</span>
                    </h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </div>
            </div>
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-order">
                    ...
                    <h2 class="text-right"><i class="zmdi zmdi-gas-station icon-size float-left text-primary"></i><span class="font-weight-bold">₹{{ $currentYearDiesel }}</span></h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </div>
            </div>
        </div>
...
<div class="row row-sm">
    <div class="col-lg-12">
        <div class="card custom-card overflow-hidden">
            <div class="card-body">
                <form method="POST" action="{{ route('diesel-reports.generate-pdf') }}">
                    <div class="row">
                        @csrf
                        ...
                        <div class="col-md-4 mt-2">
                            <div class="form-group">
                                <select class="form-control select2" name="vehicle_id" id="vehicle_id">
                                    <option value="" selected disabled>Vehicles</option>
...
<div class="row row-sm">
    <div class="col-lg-12">
        <div class="card custom-card overflow-hidden">
            <div class="card-body">
                <div class="table-responsive" id="diesel-container">
