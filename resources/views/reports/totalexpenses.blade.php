...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Totle System Expenses</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">System Expenses</li>
            </ol>
        </div>
    </div>
    <!-- End Page Header -->
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div class="card-order">
                        <label class="main-content-label mb-3 pt-1">Total System Expenses</label>
                        <h2 class="text-right"><i class="icon-size zmdi zmdi-money-box float-left text-primary"></i><span
                                class="font-weight-bold">₹{{ number_format($totalExpense) }}</span></h2>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div class="card-order">
                        ...
                        <h2 class="text-right"><i class="zmdi zmdi-money-box icon-size float-left text-primary"></i><span
                                class="font-weight-bold">₹{{ number_format($currentMonthExpense) }}</span></h2>
                        <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                    </div>
                </div>
            </div>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div class="card-order">
                        ...
                        <h2 class="text-right"><i class="zmdi zmdi-money-box icon-size float-left text-primary"></i><span
                                class="font-weight-bold">₹{{ number_format($prevMonthExpense) }}</span></h2>
                        <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                    </div>
                </div>
            </div>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div class="card-order">
                        ...
                        <h2 class="text-right"><i class="zmdi zmdi-money-box icon-size float-left text-primary"></i><span
                                class="font-weight-bold">₹{{ number_format($currentYearExpense) }}</span></h2>
                        <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                    </div>
                </div>
            </div>
    ...
    <div class="row row-sm">
        <div class="col-lg-12">
            <div class="card custom-card overflow-hidden">
                <div class="card-body">
                    <form method="POST" action="{{ route('total-expenses-reports.generate-pdf') }}">
                        <div class="row">
                            @csrf
    ...
    <div class="row row-sm">
        <div class="col-lg-12">
            <div class="card custom-card overflow-hidden">
                <div class="card-body">
                    <div class="table-responsive" id="total-expenses-container">
...
@section('script')
    ...
    @include('reports.JS.total_expenses_js')
@endsection
