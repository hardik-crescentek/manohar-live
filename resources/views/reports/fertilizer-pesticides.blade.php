        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-order">
                    ...
                    <h2 class="text-right"><i class="icon-size mdi mdi-flower float-left text-primary"></i><span class="font-weight-bold">₹{{ $totalFP }}</span></h2>
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-order">
                    ...
                    <h2 class="text-right"><i class="mdi mdi-flower icon-size float-left text-primary"></i><span class="font-weight-bold">₹{{ $currentMonthFP }}</span></h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="card-order ">
                    ...
                    <h2 class="text-right card-item-icon card-icon">
                        <i class="mdi mdi-flower icon-size float-left text-primary"></i><span class="font-weight-bold">₹{{ $prevMonthFP }}</span>
                    </h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </div>
            </div>
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-order">
                    ...
                    <h2 class="text-right"><i class="mdi mdi-flower icon-size float-left text-primary"></i><span class="font-weight-bold">₹{{ $currentYearFP }}</span></h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </div>
            </div>
        </div>
...
<div class="row row-sm">
    <div class="col-lg-12">
        <div class="card custom-card overflow-hidden">
            <div class="card-body">
                <form method="POST" action="{{ route('fertilizer-pesticides-reports.generate-pdf') }}">
                    <div class="row">
                        @csrf
...
<div class="row row-sm">
    <div class="col-lg-12">
        <div class="card custom-card overflow-hidden">
            <div class="card-body">
                <div class="table-responsive" id="fertilizer-pesticides-container">
