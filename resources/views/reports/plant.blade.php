        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-order">
                    ...
                    <h2 class="text-right"><i class="icon-size mdi mdi-flower float-left text-primary"></i><span class="font-weight-bold">₹{{ $totalPlants }}</span></h2>
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-order">
                    ...
                    <h2 class="text-right"><i class="mdi mdi-flower icon-size float-left text-primary"></i><span class="font-weight-bold">₹{{ $currentMonthPlants }}</span></h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="card-order ">
                    ...
                    <h2 class="text-right card-item-icon card-icon">
                        <i class="mdi mdi-flower icon-size float-left text-primary"></i><span class="font-weight-bold">₹{{ $prevMonthPlants }}</span>
                    </h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </div>
            </div>
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-order">
                    ...
                    <h2 class="text-right"><i class="mdi mdi-flower icon-size float-left text-primary"></i><span class="font-weight-bold">₹{{ $currentYearPlants }}</span></h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </div>
            </div>
        </div>
