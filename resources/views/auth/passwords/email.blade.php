                ...
                <div class="row row-sm">
                    <div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
                        <div class="mt-5 pt-4 p-2 pos-absolute">
                            ...
                            <span class="tx-white-6 tx-13 mb-5 mt-xl-0">You will receive link in email to reset passeord.</span>
                        </div>
                    </div>
                            ...
                            <div class="row row-sm">
                                <div class="card-body mt-2 mb-2">
                                    ...
                                    <form method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <p class="mb-4 text-muted tx-13 ml-0 text-left">You will receive link in email to reset passeord.</p>
                                        ...
                                        <button class="btn ripple btn-main-primary btn-block">Send Password Reset Link</button>
                                    </form>
