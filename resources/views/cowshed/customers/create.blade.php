...
<div class="page-header">
    <div>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('cowshed.customers.index') }}">Customer</a></li>
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-2">
                    <h6 class="main-content-label">Customer Details</h6>
                </div>
                <form class="parsley-validate" method="post" action="{{ route('cowshed.customers.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row row-sm">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="milk" type="text" value="{{ old('milk') }}" required="">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
