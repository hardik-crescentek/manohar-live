...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">Ghee Report</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Ghee Report</li>
        </ol>
    </div>
</div>
<!-- End Page Header -->
...
<div class="row row-sm">
    <div class="col-lg-12">
        <div class="card custom-card overflow-hidden">
            <div class="card-body">
                <form method="POST" action="{{ route('cowshed.ghee-reports.generate-pdf') }}">
                    <div class="row">
                        @csrf
...
@include('cowshed.reports.JS.ghee_js')
