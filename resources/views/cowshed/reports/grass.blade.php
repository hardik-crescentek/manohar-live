...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">Grass Report</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Grass Report</li>
        </ol>
    </div>
</div>
<!-- End Page Header -->
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-order">
                    ...
                    <h2 class="text-right"><i class="icon-size zmdi zmdi-money-box float-left text-primary"></i><span class="font-weight-bold">₹{{ $totalGrass }}</span></h2>
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-order">
                    ...
                    <h2 class="text-right"><i class="zmdi zmdi-money-box icon-size float-left text-primary"></i><span class="font-weight-bold">₹{{ $currentMonthGrass }}</span></h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="card-order ">
                    ...
                    <h2 class="text-right card-item-icon card-icon">
                        <i class="zmdi zmdi-money-box icon-size float-left text-primary"></i><span class="font-weight-bold">₹{{ $prevMonthGrass }}</span>
                    </h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </div>
            </div>
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-order">
                    ...
                    <h2 class="text-right"><i class="zmdi zmdi-money-box icon-size float-left text-primary"></i><span class="font-weight-bold">₹{{ $currentYearGrass }}</span></h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </div>
            </div>
        </div>
...
<div class="row row-sm">
    <div class="col-lg-12">
        <div class="card custom-card overflow-hidden">
            <div class="card-body">
                <form method="POST" action="{{ route('cowshed.grass-reports.generate-pdf') }}">
                    <div class="row">
                        @csrf
...
@include('cowshed.reports.JS.grass_js')
