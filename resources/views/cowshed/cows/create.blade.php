    ...
    <div class="col-lg-12 col-md-12">
        <div class="card custom-card">
            <div class="card-body">
                ...
                <form class="parsley-validate" method="post" action="{{ route('cowshed.cows.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row row-sm">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="tag_number" type="number" value="{{ old('tag_number') }}" required="">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="milk" value="{{ old('milk') }}" min="0">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="">Age</label>
                                <input class="form-control" name="age" onkeypress="return onlyDecimal(event)" type="number" value="{{ old('age') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mg-b-20">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" type="text" name="date" id="datepicker">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="grade" type="text" value="{{ old('grade') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
