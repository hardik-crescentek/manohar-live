    ...
    <div class="col-lg-12 col-md-12">
        <div class="card custom-card">
            <div class="card-body">
                ...
                <form class="parsley-validate" method="post" action="{{ route('cowshed.ghee-management.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row row-sm">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="">Ghee (Litr) <span class="text-danger">*</span></label>
                                <input class="form-control" name="ghee" required="" onkeypress="return onlyDecimal(event)" type="text" value="{{ old('ghee') }}">
                                @error('ghee') <ul class="parsley-errors-list filled"> <li class="parsley-required">{{ $message }}</li> </ul> @enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="">Milk (Litr) <span class="text-danger">*</span></label>
                                <input class="form-control" name="milk" required="" onkeypress="return onlyDecimal(event)" type="text" value="{{ old('milk') }}">
