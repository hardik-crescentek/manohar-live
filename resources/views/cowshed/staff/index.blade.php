        ...
        <div class="card custom-card overflow-hidden">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-2">
                    <h6 class="main-content-label">Staff</h6>
                    @if(Auth::user()->hasrole('super-admin') || Auth::user()->can('staffs-add'))
                    <a href="{{ route('cowshed.staffs.create') }}" class="btn btn-primary">Add</a>
                    @endif
                </div>
                <div class="d-flex justify-content-between mb-2">
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", '.delete-staffs', function() {
    ...
    function getTable() {
        ...
        $.ajax({
            url: "{{ route('cowshed.staff.get-table') }}",
            type: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
                type: type
