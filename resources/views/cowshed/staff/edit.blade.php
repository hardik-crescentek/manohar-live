...
<div class="page-header">
    <div>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('cowshed.staffs.index') }}"> Staffs</a></li>
    ...
    <div class="col-lg-12 col-md-12">
        <div class="card custom-card">
            <div class="card-body">
                ...
                <form class="parsley-validate" method="post" action="{{ route('cowshed.staffs.update', $staff->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row row-sm">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" placeholder="YYYY/MM/DD" type="text" name="joining_date" id="joining_date" value="{{ date('m-d-Y', strtotime($staff->joining_date)) }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" placeholder="YYYY/MM/DD" type="text" name="resign_date" id="resign_date" value="{{ date('m-d-Y', strtotime($staff->resign_date)) }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row row-sm mt-4">
                        <div class="col-md-12 col-lg-12 col-xl-12">
                            <a href="{{ route('cowshed.staffs.index') }}" class="btn btn-primary">Back</a>
