                                    ...
                                    <tr class="tr-{{$item->id}}">
                                        ...
                                        <td>
                                            @if(Auth::user()->hasrole('super-admin') || Auth::user()->can('expenses-edit'))
                                                <a href="{{ route('expenses.edit', $item->id) }}" data-toggle="tooltip" title="Edit"> <i class="fa fa-pen text-primary mr-2"></i> </a>
                                            @endif
                                            @if(Auth::user()->hasrole('super-admin') || Auth::user()->can('expenses-delete'))
                                                <a href="javascript:;" class="delete-expense" data-id="{{ $item->id }}" data-route="{{ route('expenses.destroy', $item->id) }}" data-toggle="tooltip" title="Delete"> <i class="fa fa-trash text-danger"></i> </a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
