    ...
    <div class="col-lg-12 col-md-12">
        <div class="card custom-card">
            <div class="card-body">
                ...
                <form class="parsley-validate" method="post" action="{{ route('cameras.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row row-sm">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="camera_location" required="" type="text" value="{{ old('camera_location') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control datepicker" placeholder="MM-DD-YYYY" type="text" name="purchase_date" id="purchase_date" value="" required="">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="memory_detail" type="text" value="{{ old('memory_detail') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="">Sim Number</label>
                                <input class="form-control" name="sim_number" type="text" value="{{ old('sim_number') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="">Camera Company Name</label>
                                <input class="form-control" name="camera_company_name" type="text" value="{{ old('camera_company_name') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="">Service Person Name</label>
                                <input class="form-control" name="service_person_name" type="text" value="{{ old('service_person_name') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="">Service Person Number</label>
                                <input class="form-control" name="service_person_number" type="text" value="{{ old('service_person_number') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control datepicker" placeholder="MM-DD-YYYY" type="text" name="last_cleaning_date" id="last_cleaning_date" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control" name="recharge_notification" type="text" value="{{ old('recharge_notification') }}">
