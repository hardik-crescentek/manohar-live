    ...
    <div class="col-lg-12 col-md-12">
        <div class="card custom-card">
            <div class="card-body">
                ...
                <form class="parsley-validate" method="post" action="{{ route('diesels.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row row-sm">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="price" required="" onkeypress="return onlyDecimal(event)" type="text" value="{{ old('price') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="payment_person" required="" type="text" value="{{ old('payment_person') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
